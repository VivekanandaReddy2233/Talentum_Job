    ...
    <>
      <div className="howitworks">
        <div className="container">
          <h3>How Talentum Works</h3>
          <div className="banner">
            <div className="card">
              <FaUserPlus />
              <p>Create Account</p>
              <p>
              Sign up for Talentum by providing your basic information, such as your name, email address, and a secure password. Completing your profile will help Talentum tailor job recommendations and enhance your overall experience on the platform.
              </p>
            </div>
            <div className="card">
              <MdFindInPage />
